    ...
    public boolean onContextItemSelected(MenuItem menuItem)
    {
        ...
        switch( menuItem.getItemId() ) {
            ...
            case R.id.context_op_negativo:
                ...
                toret = true;
                break;
            case R.id.context_op_logaritmo:
                this.operaUnario( Calculadora.OperadorUnario.Log );
                toret = true;
                break;
            case R.id.context_op_seno:
                this.operaUnario( Calculadora.OperadorUnario.Sen );
                toret = true;
                break;
            case R.id.context_op_coseno:
                this.operaUnario( Calculadora.OperadorUnario.Cos );
                toret = true;
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem)
    {
        ...
        switch( menuItem.getItemId() ) {
            ...
            case R.id.opDivide:
                ...
                break;
            case R.id.opResto:
                this.operaBinario( Calculadora.OperadoBinario.Res );
                toret = true;
                break;
            case R.id.opExponente:
                this.operaBinario( Calculadora.OperadoBinario.Exp );
                toret = true;
                break;
        }
